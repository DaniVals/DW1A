...
public class Profesor extends Empleado{
    ...
    public Profesor(String nombre, String apellidos, String dni, String estadoCivil, String fecha, int nDespacho,
            String departamento) {
        super(nombre, apellidos, dni, estadoCivil, fecha, nDespacho);
