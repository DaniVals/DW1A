...
public class Mates {
    ...
    public static double truncarDecimales(double numVictima, int decimalesRestantes){
        numVictima=numVictima*Math.pow(10, decimalesRestantes);
        numVictima=((double) ((int) numVictima ))/Math.pow(10, decimalesRestantes);
        return numVictima;
    }
}
