...
CREATE TABLE Especialidad(
    ...
    nombre VARCHAR(30) CONSTRAINT nombre_Especialidad_UK UNIQUE,
...
CREATE TABLE Medico(
	...
	especialidad NUMBER(4) CONSTRAINT especialidad_Medico_FK REFERENCES Especialidad(codigo)
    					   CONSTRAINT especialidad_Medico_NN NOT NULL,
	turno_trabajo VARCHAR(10) CONSTRAINT turno_trabajo_Medico_CK CHECK (turno_trabajo IN ('M','T')),
...
INSERT INTO Asignado VALUES('1001001Z', '404040', DATE '2023-11-10');
INSERT INTO Asignado VALUES('222222R', '404040', DATE '2022-05-15');
